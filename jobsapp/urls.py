...
urlpatterns = [
    ...
    path('employee/dashboard/', include([
        path('', EDashboardView.as_view(), name='employee-dashboard'),
         path('dsi', DSIView.as_view(), name='employee-dsi'),
        # path('applicants/<int:job_id>', ApplicantPerJobView.as_view(), name='employee-dashboard-applicants'),
        # path('mark-filled/<int:job_id>', filled, name='job-mark-filled'),
    ])),
    ...
    path('lb', LeaderView.as_view(), name='leader'),
